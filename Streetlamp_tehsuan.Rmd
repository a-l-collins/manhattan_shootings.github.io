...
<img src="./Figures/pexels-muffin-1629998.jpg">
...
mapview(
  ...
  layer.name = "Unlit Street Lights per Tract (2025)",
  alpha.regions = 0.7
) + 
mapview(
  shooting25_sf, 
...
mapview(
  ...
  layer.name = "Cumulative Unlit Street Lights (2020-2025)",
  alpha.regions = 0.7
) + 
mapview(
...
# Stratified analysis by day time and night time
...
knitr::kable(
  summary_table,
  caption = "Poisson Regression Results: Unlit Street Lights vs. Shooting Cases (2025) Stratified by Day Time",
...
knitr::kable(
  summary_table_gee,
  caption = "GEE Poisson Regression Results: Unlit Street Lights vs. Shooting Cases (2020-2025) Stratified by Day Time",
