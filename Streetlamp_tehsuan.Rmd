...
#### Part 2: Statistical Analysis (Poisson and GEE)
...
#### Part 3: Stratified Analysis by Daylight Hours
...
##### Step 2: Cross-Sectional Analysis in 2025 (Daylight Stratified)

###### Day Time (based on monthly sunrise/sunset)
```{r}
...
###### Night Time (based on monthly sunrise/sunset)
```{r}
...
summary_table <- tibble(
  `Time Period` = c("Daytime (Date-Specific)", "Nighttime (Date-Specific)"),
...
knitr::kable(
  summary_table,
  caption = "Poisson Regression Results: Broken Street Lights vs. Shooting Cases (2025) Stratified by Date-Specific Daylight",
  col.names = c("Time Period", "IRR (Incidence Rate Ratios)", "P-value")
)
```

##### Step 3: Longitudinal GEE Analysis (Daylight Stratified: 2020-2025)
...
summary_table_gee <- tibble(
  `Time Period` = c("Daylight (Monthly Avg)", "Nighttime (Monthly Avg)"),
...
knitr::kable(
  summary_table_gee,
  caption = "GEE Poisson Regression Results: Broken Street Lights vs. Shooting Cases (2020-2025) Stratified by Monthly Daylight",
