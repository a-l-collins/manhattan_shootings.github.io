...
# Part 1: Description: interactive map visualizations

This section prepares the data for spatial analysis and visualizes the distribution of the outcome (shooting incidents) and the primary predictor (street lights out) across Manhattan census tracts.
