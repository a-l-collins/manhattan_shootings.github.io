...
Model (Cross-sectional analysis): Poisson model
Mode2 (Longitudinal analysis): GEE model
...
# Part 3: Stratified analysis to see if there is different association between shooting case happen in day time and night time
